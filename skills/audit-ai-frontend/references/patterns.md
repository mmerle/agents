...
- Keep CSS utility use idiomatic, but move recurring recipes into `cn`, `cva`, local variants, or project primitives when the repo already uses them.
...
- repeated variant strings and ad hoc styling: `variant ===`, `className={`, `style={{`
